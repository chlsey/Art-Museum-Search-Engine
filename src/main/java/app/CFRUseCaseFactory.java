...
public class CFRUseCaseFactory {
    public static CFRView create(ViewManagerModel viewManagerModel, SearchViewModel searchViewModel,
        ...
        final RatingController ratingController = createRatingUseCase(viewManagerModel,searchViewModel, clickArtViewModel, cfrViewModel, museumDataAccessObject);
        final FavoriteController favoriteController = createFavoriteUseCase(viewManagerModel, searchViewModel, clickArtViewModel, cfrViewModel, museumDataAccessObject);
        return new CFRView(cfrViewModel, clickArtViewModel, ratingController, favoriteController , commentController);
    }
    ...
    private static FavoriteController createFavoriteUseCase(ViewManagerModel viewManagerModel,
        ...
        final FavoriteOutputBoundary favoriteOutputBoundary = new FavoritePresenter(cfrViewModel,viewManagerModel,clickViewModel,searchViewModel);
        final FavoriteInputBoundary favoriteInteractor = new FavoriteInteractor(dataAccessObject, favoriteOutputBoundary);
    ...
    private static RatingController createRatingUseCase(ViewManagerModel viewManagerModel,
                                                          ...
                                                          CFRViewModel cfrViewModel,
                                                          FileArtworkDataAccessObject dataAccessObject) {
        final RatingOutputBoundary ratingOutputBoundary = new RatingPresenter(cfrViewModel,viewManagerModel,clickViewModel,searchViewModel);
